...
- Established nicknames: `The Boy Who Lived`, `Mad-Eye`, Dark Lord`, `You-Know-Who`
- Ghosts: `Nearly Headless Nick`, `Moaning Myrtle`, `Bloody Baron`
...
| `Dark Lord` | CHAR | Established nickname for Voldemort |
...
- Named rooms: `Great Hall`, `Room of Requirement`, `Chamber of Secrets`
- Named natural features: `Forbidden Forest`, `Black Lake`, `Astronomy Tower`
...
- Government bodies: `Ministry of Magic`, `Wizengamot`, `MACUSA`
- Named groups and movements: `Order of the Phoenix`, `Dumbledore's Army`, `Death Eaters`
- Sports teams: `Holyhead Harpies`, `Chudley Cannons`
...
| `Marauders` | ORG | Named group |
| `Auror Office` | ORG | Named department |
| `Gringotts` | ORG | Named institution |
| `S.P.E.W.` | ORG | Named society |
| `Daily Prophet` (outlet) | ORG | |
